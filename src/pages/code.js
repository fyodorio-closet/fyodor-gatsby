...
const CodePage = () => (
  <Layout>
    <div>
      <Helmet title={`Fyodor Loenko - Code`} />
      ...
      <ul>
        <li><a href="https://github.com/loenko/ng-hotrod">ng-hotrod</a> - simple modern starter for AngularJS + Angular Material + ES6 + Sass + Webpack using latest AngularJS best practices and approaches</li>
        <li><a href="https://github.com/loenko/my-days-of-code">my-days-of-code</a> - the repository for this site made with Gatsby and React where I experiment with these two tools along with GraphQL, Sass, Markdown and other interesting stuff</li>
