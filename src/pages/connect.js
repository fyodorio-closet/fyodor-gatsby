    ...
    <div>
      ...
      <ul className="accounts">
        <li className="account">
          <a target="_blank" rel="noopener noreferrer" href="mailto:fyodor.loenko@mailhero.io">
            <FontAwesomeIcon icon={faEnvelope} size={iconSize} />
          </a>
          <div className="account-name">fyodor.loenko@mailhero.io</div>
        </li>
        <li className="account">
          <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/fyodorio">
            <FontAwesomeIcon icon={faTwitter} size={iconSize} />
          </a>
          <div className="account-name">@fyodorio</div>
        </li>
        <li className="account">
          <a target="_blank" rel="noopener noreferrer" href="https://github.com/loenko">
            <FontAwesomeIcon icon={faGithub} size={iconSize} />
          </a>
          <div className="account-name">@loenko</div>
        </li>
        <li className="account">
          <a target="_blank" rel="noopener noreferrer" href="https://codepen.io/loenko/">
            <FontAwesomeIcon icon={faCodepen} size={iconSize} />
          </a>
          <div className="account-name">@loenko</div>
        </li>
        <li className="account">
          <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/users/6778546/fyodor">
